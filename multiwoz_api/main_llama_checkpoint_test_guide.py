...
#For SFT model, e.g. llama8instructsft-checkpoint-78
#   use_peft = True
...
for idx, convo_key in enumerate(tqdm(set_to_run)):
    ...
    with open(f"{cwd}/records/kto_v2_Aug25_guide/simulation_{convo_key.split('.json')[0]}_{time.ctime().replace(' ','_')}.json", 'w') as file:
